#!/usr/bin/env python3
"""
Version de test avec des points VISIBLES pour vérifier le fonctionnement
"""
...
class SubtitleEncoderVisible:
    def __init__(self, grid_size: Tuple[int, int] = (10, 10)):
        """
        Initialise l'encodeur avec des points VISIBLES pour test
        """
        self.grid_width, self.grid_height = grid_size
        self.grid_size = grid_size
        self.point_size = 8  # Points plus gros
        self.point_intensity = 50  # Variation beaucoup plus visible
    ...
    def add_visible_points(self, frame: np.ndarray, positions: List[Tuple[int, int]], 
        ...
        """
        Ajoute des points BIEN VISIBLES sur une frame
        """
        ...
        for x, y in positions:
            ...
            # Dessiner un cercle ROUGE bien visible
    ...
    def encode_video(self, video_path: str, srt_path: str, output_path: str):
        """Encode la vidéo avec des points VISIBLES"""
        ...
        while True:
            ...
            for subtitle in subtitles:
                if subtitle['start_time'] <= current_time <= subtitle['end_time']:
                    # Convertir le texte en positions
        ...
        print(f"Vidéo avec points VISIBLES: {output_path}")
        print(f"Mapping de référence: {mapping_path}")

def main():
    parser = argparse.ArgumentParser(description='Encoder avec des points VISIBLES')
    ...
    encoder = SubtitleEncoderVisible()
